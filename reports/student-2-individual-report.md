...
My work is defined in `docs/collaboration-plan.md` under "Student 2".
...
**The gap this addressed.** A registry adding a graduating cohort of several hundred students had to use the single-record form for each one. Bulk import was listed as out of scope for the baseline in `docs/requirements.md` section 6.

**Acceptance criteria met:** see `docs/collaboration-plan.md`, Task 2.1.
...
### Task 2.2 - Sortable columns in the register

**Branch:** `feature/qualifications-sortable-columns`
**Issue:** `[INSERT ISSUE NUMBER]`
**Pull request:** `[INSERT PR NUMBER]`

**The gap this addressed.** The register listed newest-first only, so a registrar could not order by award date or holder name.

**Acceptance criteria met:** see `docs/collaboration-plan.md`, Task 2.2.
...
| --- | --- | ---: | --- | --- |
| `feature/qualifications-bulk-import` | Bulk registration from CSV | `[N]` | `[DATE]` | `[#N]` |
| `feature/qualifications-sortable-columns` | Sortable columns in the register | `[N]` | `[DATE]` | `[#N]` |
