...
My work is defined in `docs/collaboration-plan.md` under "Student 3".
...
### Task 3.1 - Date-range filtering and CSV export for the audit trail

**Branch:** `feature/audit-export-and-date-filter`
**Issue:** `[INSERT ISSUE NUMBER]`
**Pull request:** `[INSERT PR NUMBER]`

**The gap this addressed.** The audit trail could only be filtered by action type and browsed page by page. An auditor asking for a specific date range could not be answered, and there was no way to hand the evidence over.

**Acceptance criteria met:** see `docs/collaboration-plan.md`, Task 3.1.
...
### Task 3.2 - Shareable, expiring public verification receipt

**Branch:** `feature/verification-shareable-receipt`
**Issue:** `[INSERT ISSUE NUMBER]`
**Pull request:** `[INSERT PR NUMBER]`

**The gap this addressed.** A verification receipt was visible only to signed-in users, so a graduate could not give an employer proof without the employer holding an account.

**Acceptance criteria met:** see `docs/collaboration-plan.md`, Task 3.2.
...
| --- | --- | ---: | --- | --- |
| `feature/audit-export-and-date-filter` | Date-range filtering and CSV export for the audit trail | `[N]` | `[DATE]` | `[#N]` |
| `feature/verification-shareable-receipt` | Shareable, expiring public verification receipt | `[N]` | `[DATE]` | `[#N]` |
